   ...
   public class LicenseData
    {
            ...
            ref String NationalNo, ref bool IsActive, ref byte IssueReason, ref int Gendor,ref DateTime DateOfBirth ,ref string ImagePath)
        {
            ...
            string query = "select LicenseClasses.ClassName, People.FirstName +'' + People.SecondName + ''+People.ThirdName +''+People.LastName as Fullname,  People.NationalNo, People.Gendor, People.DateOfBirth, People.ImagePath, Licenses.LicenseID, Licenses.IssueDate, Licenses.IssueReason, Licenses.IsActive, Licenses.Notes, Licenses.DriverID, Licenses.ExpirationDate from Licenses inner join Drivers  on Licenses.DriverID= Drivers.DriverID inner join People on Drivers.PersonID= People.PersonID inner join LicenseClasses on Licenses.LicenseClass = LicenseClasses.LicenseClassID where Licenses.LicenseID = @LicenseID";
        ...
        public static bool IsLicenseExist(int LicenseID)
        {
            ...
            string query = "SELECT Licenses.DriverID FROM Licenses WHERE Licenses.ApplicationID= @LicenseID";
